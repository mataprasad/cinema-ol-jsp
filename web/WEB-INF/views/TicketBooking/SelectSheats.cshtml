            ...
            @{
                ...
                for (int i = 0; i < Model.Count; i++)
                {
                    ...
                    output += @" 
                     ...
                     $('#chk" + id + @"').attr('checked', 'checked');
                     $('#chk" + id + @"').parent().css('background-color', 'red');";
                };}
            @Html.Raw(output)
...
<form action="@Url.Action("ConfirmSelection", "TicketBooking")" method="post">
        ...
        <div>
            <div style="padding: 0px; margin: 0px auto 0px auto; width: 900px;">
                <div style="padding: 0px; margin: 0px auto 0px auto; width: 380px;">
                    <img alt="" src="@Url.Content("~/images/appImages/screen.jpg")" />
                </div>
                <div>
                    <hr />
                </div>
                        ...
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td colspan="2" rowspan="2">
                                    <input type="image" style="height: 30px; width: 100px;" src="@Url.Content("~/images/appImages/btnNext.png")" />
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
    ...
    @Html.Hidden("ShowId", Context.Session.GetItem("ShowId"));
