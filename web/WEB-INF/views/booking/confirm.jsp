...
@model ShowDetail
@{
    ViewBag.Title = "ConfirmSelection";
}
...
<form action="@Url.Action("BookTicket","TicketBooking")" method="post">
            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td align="left" style="background-color: #FF9900">
                        ...
                        <input type="image" style="width:100px; height:30px;" src="@Url.Content("~/images/appImages/btnConfirm.png")"/>
                    </td>
                    <td align="left" style="background-color: #FF9900"></td>
                </tr>
            </table>
