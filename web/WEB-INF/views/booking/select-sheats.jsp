...
<t:_layout>
    ...
    <jsp:body>
        <form action="<c:url value="/user?do=tix-booking"/>" method="post">
                ...
                <div>
                    <div style="padding: 0px; margin: 0px auto 0px auto; width: 900px;">
                        <div style="padding: 0px; margin: 0px auto 0px auto; width: 380px;">
                            <img alt="" src="<c:url value="images/appImages/screen.jpg"/>" />
                        </div>
                        <div>
                            <hr />
                        </div>
                                ...
                                <table class="style1">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" rowspan="2">
                                            <input type="image" style="height: 30px; width: 100px;" src="<c:url value="/images/appImages/btnNext.png"/>" />
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
