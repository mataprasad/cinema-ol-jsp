				...
				<table class="style1">
					<tr>
						...
						<td style="background-color: #FF9900"><span
							id="lblBookingDate" style="color: White; font-weight: bold;">@Model.Booking_Date.ToString()</span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="style3" colspan="3" style="background-color: #FF9900">
							<span id="lblMovieTitle" style="color: White; font-weight: bold;">@Model.Movie_Name.ToString()</span>
						</td>
					</tr>
					<tr>
						...
						</td> @{ Decimal totalCost = 0; String row = ""; foreach
						(SelectListItem rows in Model.Sheats) { row += "
						<tr>
