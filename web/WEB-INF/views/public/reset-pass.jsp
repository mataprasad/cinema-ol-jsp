...
<form action="<c:url value="/public?do=resset-pass"/>" method="post"
				...
				<div align="center">
					<table class="style2">
						...
						<tr>
							...
							<td align="left">
								<input type="text" readonly="readonly" value="@ViewBag.SQ"
											style="border-color: #993333; border-style: solid; border-width: 1px; width: 150px;" />
							</td>
							<td>&nbsp;</td>
						</tr>
				...
				<div align="center">
					<table class="style2">
						...
						<tr>
							...
							<td align="left">
								<input name="txtNewPass" id="txtNewPass" type="text"
											style="border-color: #993333; border-style: solid; border-width: 1px; width: 150px;" />
								</td>
							<td align="left"></td>
						</tr>
						<tr>
							...
							<td align="left">
								<input name="txtRePass" id="txtRePass" type="text"
											style="border-color: #993333; border-style: solid; border-width: 1px; width: 150px;" />
								</td>
							<td align="left"></td>
						</tr>
